...
import {isUserLogin , FirebaseGetData, FirebaseLogin } from "../../config/Firebase/firebaseMethords";
...
function Login() {
    ...
    let clickHandler = () => {
        ...
        else FirebaseLogin(inpVal).then((res:any) => {
            FirebaseGetData(`user/${res.res.user.uid}`)
            .then((res: any) => res.Role === "admin" ? Navigate(`/admin`) : Navigate("/quiz"))
        })
